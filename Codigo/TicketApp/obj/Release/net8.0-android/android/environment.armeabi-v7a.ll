...
@dso_cache = dso_local local_unnamed_addr global [666 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 468791956, ; hash 0x1bf13294, from name: aot-TicketApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1379782471, ; hash 0x523dcf47, from name: TicketApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TicketApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	...
	%struct.DSOCacheEntry {
		i64 2938791923, ; hash 0xaf2a67f3, from name: TicketApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TicketApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
	...
	%struct.DSOCacheEntry {
		i64 2965574879, ; hash 0xb0c314df, from name: aot-TicketApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TicketApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 450
	...
	%struct.DSOCacheEntry {
		i64 3704654912, ; hash 0xdcd08c40, from name: libaot-TicketApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TicketApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 577
	...
	%struct.DSOCacheEntry {
		i64 4259801032, ; hash 0xfde767c8, from name: libaot-TicketApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TicketApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 658
